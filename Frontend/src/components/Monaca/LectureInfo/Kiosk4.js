            ...
            <Section1>
               ...
               <SecInner1 style={{ backgroundImage: `url(${lectureData.length > 0 ? lectureData[0].image: ''})` }} />
                  <SecInner2>
                   <InfoWrap>
                        <LectureCategory>  
                            {lectureData.length > 0 ? lectureData[0].lectureCategory : "Loading..."}</LectureCategory>
                            <LectureName>
                     ...
                     &#62;
                        ...
                        <ProfessorName> {lectureData.length > 0
                  ...
                  <ProInfo>
                     <ProProfile>
                        <Professor>
                           ...
                           <h2 onClick={navigateToKioskPf1}> {lectureData.length > 0
                           ? lectureData[0].professor : "Loading..."}</h2>
                           <h3>교수님</h3>
                        </Professor>
                        <ProIntro>
                         <h4> {data.length > 0 ? data[0].professorIntro : "Loading..."}</h4>
                        </ProIntro>
                     </ProProfile>
                  </ProInfo>
               </Info>
