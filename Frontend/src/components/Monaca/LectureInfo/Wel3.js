...
export function Wel3() {
   ...
   const navigateToWel3Notice = () => {
      navigate("/wel3-notice");
   };
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     <SelectBtn onClick={navigateToWel3}>강의 소개</SelectBtn>
                     <SelectBtn onClick={navigateToWel3QnA}>QnA</SelectBtn>
                     <SelectBtn onClick={navigateToWel3Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
               <Info>
                  ...
                  <Inner1>
                     ...
                     <InWrap>
                        <InText>✔ 복잡한 시스템 간단하게 인식하기</InText>
                        <InText>✔ 어려웠던 방법 노하우로 내 걸로 만들기</InText>
                     </InWrap>
                     <InTitle>
                        수강 전 확인하기 <Check />
                     </InTitle>
                  ...
                  <Bar>
                     <p>보기만 해도 멀미가 나던 과정들</p>
                     <p>모나카 멀미약으로 완치 &#128293;</p>
                  </Bar>
                  <Header2>
                     <h2>강의 목표</h2>
                     <br />
                     <p>여기저기 헤매지 말고, 화내지 말고</p>
                     <p>즐기면서 신청할 수 있게!</p>
                  </Header2>
                  <Inner2>
                     <SubIn1>
