      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     <SelectBtn onClick={navigateToWeb3}>강의 소개</SelectBtn>
                     <SelectBtn onClick={navigateToWeb3QnA}>QnA</SelectBtn>
               ...
               <Info>
                  <Header>
                     ...
                     <br />
                     <p>
                        이 강의에서는 웹사이트의 다양한 기능과 활용방법을 배우고
                        <br />
                        적용할 수 있습니다. 지금 신청하세요!
                     </p>
                  </Header>
                  <Inner1>
                     ...
                     <InWrap>
                        <InText> ✔ 웹사이트 개념 활용하기</InText>
                        <InText> ✔ 종류별 돌발상황 대처하기</InText>
                     </InWrap>
                     <InTitle>
                        수강 전 확인하기 <Check />
                     </InTitle>
                  ...
                  <Bar>
                     <p>초보자 딱지를 떼고 싶은 사람</p>
                     <p>해당강의 수강하고 중급자로 올라가자 &#128293;</p>
                  </Bar>
                  <Header2>
                     <h2>강의 목표</h2>
                     <br />
                     <p>웹사이트 사용시 마주치는 돌발상황이나</p>
                     <p>원하는 방향으로 환경을 바꿀 수 있게!</p>
                  </Header2>
                  <Inner2>
                     <SubIn1>
                        <h2>
                  ...
                  <ProInfo>
                     ...
                     <Professor>
                           ...
                           <h2 onClick={navigateToWebPf2}> {lectureData.length > 0
                           ? lectureData[0].professor : "Loading..."}</h2>
                           <h3>교수님</h3>
                        </Professor>
                        <ProIntro>
                           <h4>
                           {data.length > 4 ? data[4].professorIntro : "Loading..."}
                           </h4>
                        </ProIntro>
                     </ProProfile>
