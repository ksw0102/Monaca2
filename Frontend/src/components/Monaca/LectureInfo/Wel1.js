      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     <SelectBtn onClick={navigateToWel1}>강의 소개</SelectBtn>
                     <SelectBtn onClick={navigateToWel1QnA}>QnA</SelectBtn>
               ...
               <Info>
                  <Header>
                     <h2>모나카에서 세 번째로 인기가 많은</h2>
                     <h2>국가 복지 및 민원 신청법 강의입니다.</h2>
                     <br />
                     <p>
                        국가의 복지혜택,민원에 대한 기본개념을 <br />
                        이해하고 간단한 처리 방법에 대해 알아볼 수 있습니다.
                     </p>
                     <br />
                     <p>
                        내가 어디에 해당되는지, 신청은 할 수 있는지
                        <br />
                        일일이 찾아가 알아볼 수 없다면 모나카와함께
                     </p>
                  </Header>
                  <Inner1>
                     <InTitle>
                     ...
                     <InWrap>
                        <InText> ✔ 전반적인 시스템 이해하기</InText>
                        <InText> ✔ 종류별 복지, 민원 분류 알아보기</InText>
                     </InWrap>
                     <InTitle>
                        수강 전 확인하기 <Check />
                     </InTitle>
                     <InWrap>
                        <SubText>
                           ✔ 기초수업이기 때문에 분류보다는 신청법에 관심이
                           있으신 분은 건강한 사회 만들기를 추천드립니다.
                        </SubText>
                        <SubText>
                           {" "}
                  ...
                  <Bar>
                     <p>초보자를 위한 국가복지 및 민원신청 강의</p>
                     <p>기초를 알아야 한 단계 성장 할 수 있다 &#128293;</p>
                  </Bar>
                  <Header2>
                     <h2>강의 목표</h2>
                     <br />
                     <p>내가 해당되는 복지를 알아보고</p>
                     <p>전반적인 시스템을 이해해요!</p>
                  </Header2>
                  <Inner2>
                     <SubIn1>
                  ...
                  <ProInfo>
                     ...
                     <Professor>
                           ...
                           <h2 onClick={navigateToWelPf1}> {lectureData.length > 0
                           ? lectureData[0].professor : "Loading..."}</h2>
                           <h3>교수님</h3>
                        </Professor>
                        <ProIntro>
                           <h4>
                           {data.length > 0 ? data[7].professorIntro : "Loading..."}
                           </h4>
                        </ProIntro>
                     </ProProfile>
