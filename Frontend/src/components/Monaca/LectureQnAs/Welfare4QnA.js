...
export function Welfare4QnA() {
   ...
   const navigateToWel4Notice = () => {
      navigate("/wel4-notice");
   }
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     ...
                     <SelectBtn onClick={navigateToWel4Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
            ...
            <Section3>
               <List>
                  <ListTitle>
                     <button onClick={navigateToDoWelQ4}>질문하러 가기</button>
                  </ListTitle>
                  <ListMain>
                     <ul>
                        {contents.map((c, i) => (
