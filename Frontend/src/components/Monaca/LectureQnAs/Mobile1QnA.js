...
export function Mobile1QnA() {
   ...
   const navigateToMob1Notice = () => {
      navigate("/mob1-notice");
   }
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     <SelectBtn onClick={navigateToMobile1}>
                        강의 소개
                     </SelectBtn>
                     <SelectBtn onClick={navigateToMobile1QnA}>QnA</SelectBtn>
                     <SelectBtn onClick={navigateToMob1Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
            ...
            <Section3>
               <List>
                  <ListTitle>
                     <button onClick={navigateToDoMobQ1}>질문하러 가기</button>
                  </ListTitle>
                  <ListMain>
                     <ul>
                        {contents.map((c, i) => (
