...
export function Kiosk3QnA() {
  ...
  async function saveWishLecture(lectureId) {
    try {
       ...
       const response = await fetch(`http://localhost:8080/api/saveWishLecture/${lectureId}`, {
          method: "POST",
          headers: {
             "Content-Type": "application/json",
             Authorization: `Bearer ${loginState.token}`,
   ...
   const navigateToDoKioskQ3 = () => {
      navigate("/do-kiosk-q3");
   };
   ...
   const navigateToKiosk3Notice = () => {
      navigate("/kiosk3-notice");
   }
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     ...
                     <SelectBtn onClick={navigateToKiosk3Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
            ...
            <Section3>
               <List>
                  <ListTitle>
                     <button onClick={navigateToDoKioskQ3}>
                        질문하러 가기
                     </button>
                  </ListTitle>
                  <ListMain>
