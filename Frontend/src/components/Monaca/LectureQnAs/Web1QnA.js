...
export function Web1QnA() {
   ...
   const navigateToWeb1Notice = () => {
      navigate("/web1-notice");
   }
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     ...
                     <SelectBtn onClick={navigateToWeb1Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
            ...
            <Section3>
               <List>
                  <ListTitle>
                     <button onClick={navigateToDoWebQ1}>질문하러 가기</button>
                  </ListTitle>
                  <ListMain>
                     <ul>
                        {contents.map((c, i) => (
