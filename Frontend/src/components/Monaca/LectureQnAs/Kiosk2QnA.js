...
export function Kiosk2QnA() {
  ...
  const navigateToDoKioskQ2 = () => {
    navigate("/do-kiosk-q2");
  };
  ...
  const navigateToKiosk2Notice = () => {
    navigate("/kiosk2-notice");
  };
    ...
    <>
      ...
      <Wrapper>
        ...
        <Section2>
          <Select>
            <ButtonWrapper>
              ...
              <SelectBtn onClick={navigateToKiosk2Notice}>
                강의 공지사항
              </SelectBtn>
            </ButtonWrapper>
          </Select>
        ...
        <Section3>
          <List>
            <ListTitle>
              <button onClick={navigateToDoKioskQ2}>질문하러 가기</button>
            </ListTitle>
            <ListMain>
              <ul>
                {contents.map((c, i) => (
