...
export function Welfare5QnA() {
   ...
   const navigateToWel5Notice = () => {
      navigate("/wel5-notice");
   }
      ...
      <>
         ...
         <Wrapper>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     ...
                     <SelectBtn onClick={navigateToWel5Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
            ...
            <Section3>
               <List>
                  <ListTitle>
                     <button onClick={navigateToDoWelQ5}>질문하러 가기</button>
                  </ListTitle>
                  <ListMain>
                     <ul>
                        {contents.map((c, i) => (
