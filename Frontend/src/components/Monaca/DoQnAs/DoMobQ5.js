...
export function DoMobQ5() {
   ...
   const navigateToMob5Notice = () => {
      navigate("/mob5-notice");
   };

   const navigateToDoMobQ5 = () => {
      navigate("/do-mob-q5");
   };
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     ...
                     <SelectBtn onClick={navigateToMob5Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
               <Info>
                  ...
                  <QnAWrap>
                     ...
                     <Qbtn>
                        <button onClick={navigateToMobile5QnA}>
                           목록으로 돌아가기
                        </button>
                        <button>등록하기</button>
                     </Qbtn>
