...
export function DoMobQ2() {
   ...
   const navigateToMobile2QnA = () => {
      navigate("/mobile2-qna");
   };

   const navigateToMob2Notice = () => {
      navigate("/mob2-notice");
   };

   const navigateToDoMobQ2 = () => {
      navigate("/do-mob-q2");
   };
      ...
      <>
         ...
         <Wrapper>
               ...
               <InnerWrap>
                  ...
                  <SecInner2>
                     <InfoWrap>
                        ...
                        <LectureName>&#60;모바일 업그레이드&#62;</LectureName>
                        <br />
                        <CurrentList>현재 수강인구 수</CurrentList>
                        <ProfessorName>강태영 교수님</ProfessorName>
                     </InfoWrap>
                     <ButtonWrap>
            ...
            <Section2>
               <Select>
                  <ButtonWrapper>
                     <SelectBtn onClick={navigateToMob2}>강의 소개</SelectBtn>
                     <SelectBtn onClick={navigateToMobile2QnA}>QnA</SelectBtn>
                     <SelectBtn onClick={navigateToMob2Notice}>
                        강의 공지사항
                     </SelectBtn>
                  </ButtonWrapper>
               </Select>
               <Info>
                  ...
                  <QnAWrap>
                     ...
                     <Qbtn>
                        <button onClick={navigateToMobile2QnA}>
                           목록으로 돌아가기
                        </button>
                        <button>등록하기</button>
                     </Qbtn>
