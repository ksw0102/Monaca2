   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 5 ? data[5].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[5].name
                              ? data[5].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[5].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>디자인 박사 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[5].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[5].birthDate : "Loading..."}
                        (31세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[5].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[5].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
