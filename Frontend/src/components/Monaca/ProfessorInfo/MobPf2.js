   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 6 ? data[6].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[6].name
                              ? data[6].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[6].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>어플리케이션 디자인 박사 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[6].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[6].birthDate : "Loading..."}
                        (47세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[6].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[6].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
                           ? data[6].professorIntro
                           : "Loading..."}</h5></Me>
                     </BInner2>
                  </Box1>
               </Intro1>
