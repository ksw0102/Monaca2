   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 0 ? data[0].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[0].name
                              ? data[0].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[0].lectureCategory : "Loading..."}</CurrentList>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[0].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[0].birthDate : "Loading..."}
                        (42세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[0].email : "Loading..."}</h4></Email>
