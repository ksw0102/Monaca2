   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 3 ? data[3].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[3].name
                              ? data[3].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[3].lectureCategory : "Loading..."}</CurrentList>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[3].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[3].birthDate : "Loading..."}
                        (43세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[3].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[3].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
