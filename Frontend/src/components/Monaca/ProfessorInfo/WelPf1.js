   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 7 ? data[7].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[7].name
                              ? data[7].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[7].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>공공정책 박사 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[7].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[7].birthDate : "Loading..."}
                        (43세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[7].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[7].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
