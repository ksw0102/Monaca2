   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 1 ? data[1].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[1].name
                              ? data[1].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[1].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>전자 공학 박사 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
            ...
            <Section2>
               <Intro1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[1].name
                           ? data[1].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[1].birthDate : "Loading..."}
                        (28세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[1].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[1].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
                           ? data[1].professorIntro
                           : "Loading..."}</h5></Me>
                     </BInner2>
                  </Box1>
               </Intro1>
