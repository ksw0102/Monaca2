   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 2 ? data[2].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[2].name
                              ? data[2].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>   {lectureData.length > 0 ? lectureData[2].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>소프트웨어 공학 박사 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[2].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[2].birthDate : "Loading..."}
                        (50세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[2].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[2].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
