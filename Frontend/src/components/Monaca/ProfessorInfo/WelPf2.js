   ...
   return (
      <>
         ...
         <Wrapper>
            <Section1>
               <InnerWrap>
                  <SecInner1 style={{ backgroundImage: `url(${data.length > 8 ? data[8].image: ''})` }} />                  <SecInner2>
                     <InfoWrap>
                        <LectureCategory>  {data.length > 0 && data[8].name
                              ? data[8].name
                              : "Loading..."}</LectureCategory>
                        <br />
                        <CurrentList>{lectureData.length > 0 ? lectureData[8].lectureCategory : "Loading..."}</CurrentList>
                        <ProfessorName>사회복지 학위</ProfessorName>
                     </InfoWrap>
                  </SecInner2>
               </InnerWrap>
            </Section1>
                  ...
                  <Box1>
                     ...
                     <BInner2>
                        <Name> <h4>{data.length > 0 && data[0].name
                           ? data[8].name
                           : "Loading..."}</h4></Name>
                        <Birth> <h4> {data.length > 0 ? data[8].birthDate : "Loading..."}
                        (32세)</h4></Birth>
                        <Email>  <h4>{data.length > 0 ? data[8].email : "Loading..."}</h4></Email>
                        <Resume><h5>{data.length > 0
                           ? data[8].professorResume
                           : "Loading..."}</h5></Resume>
                        <Me><h5>{data.length > 0
                           ? data[8].professorIntro
                           : "Loading..."}</h5></Me>
                     </BInner2>
                  </Box1>
               </Intro1>
