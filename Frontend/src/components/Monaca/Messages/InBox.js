...
const Button = styled.button`
   ...
   & :nth-child(3) {
      background-image: linear-gradient(to right, white 70%, #c4d770 30%);
   }
   & button {
      border: 0;
      height: 40px;
...
export function InBox() {
   ...
   const navigateToInBoxDetaile = () => {
      navigate("/in-box-detaile");
   };
                  ...
                  <FInner>
                     <Main>
                        ...
                        <Msg>
                           ...
                           <MsgInner onClick={navigateToInBoxDetaile}>
                              <h4>123</h4>
                              <h4>123</h4>
                              <h4>2024-01-30</h4>
                              <h4>안 읽음</h4>
