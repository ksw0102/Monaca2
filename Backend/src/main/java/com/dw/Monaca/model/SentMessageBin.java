...
//@EnableScheduling
@Entity
@Table(name = "sent_message_bin")
public class SentMessageBin {

	@Id
	@Column(name = "sent_message_bin_id")
...
//	@Temporal(TemporalType.TIMESTAMP)
	...
	public SentMessageBin() {
		super();
	}

	public SentMessageBin(Long id, LocalDateTime createAt, SentMessage sentMessage) {
		super();
		this.id = id;
