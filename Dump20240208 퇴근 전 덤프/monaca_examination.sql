...
CREATE TABLE `examination` (
  ...
  `answer_text` int DEFAULT NULL,
  `date` datetime(6) NOT NULL,
  `is_correct` bit(1) DEFAULT NULL,
  `exam_exam_id` bigint DEFAULT NULL,
  `user_user_id` bigint DEFAULT NULL,
  PRIMARY KEY (`examination_id`),
  KEY `FKe4cavi2mpew1gponeralayblt` (`exam_exam_id`),
  KEY `FKmpaqy2kjusf14i4q08p37nk6c` (`user_user_id`),
  CONSTRAINT `FKe4cavi2mpew1gponeralayblt` FOREIGN KEY (`exam_exam_id`) REFERENCES `exam` (`exam_id`),
