...
CREATE TABLE `item_shop` (
  ...
  `item_category_item_category_id` bigint DEFAULT NULL,
  PRIMARY KEY (`item_shop_id`),
  KEY `FK2wcpvis86ajli99dynxjwylno` (`item_category_item_category_id`),
  CONSTRAINT `FK2wcpvis86ajli99dynxjwylno` FOREIGN KEY (`item_category_item_category_id`) REFERENCES `item_category` (`item_category_id`)
